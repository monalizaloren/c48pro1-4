  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        /* Programe que...
        se a 'currentlife', ou seja, a vida atual do jogador for menor 
        que 0, além disso...
        utilique o código que se chama 'changeImage' para alterar para a imagem para
        uma imagem de explosão*/
        ???
          cars[index - 1].???("blast");
